# Junk Oracle calculation

How Wizda turns the scraped drop tables into the Junk Oracle's answer: **"how much junk must I farm to guarantee item X?"** Read [`docs/domain.md`](../domain.md) first for the game model and data structure — this doc assumes it and focuses on the math.
